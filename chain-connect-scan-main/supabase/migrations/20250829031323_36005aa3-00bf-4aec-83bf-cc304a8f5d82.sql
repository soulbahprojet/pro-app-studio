-- SYSTÈME D'ACTIVATION COMPLÈTE DES FONCTIONNALITÉS - CORRIGÉ
...
-- 8. Fonction pour vérifier l'abonnement vendeur
...
-- 9. Insertion des fonctionnalités de base par rôle
...
('seller', 'product_management', true, false, 'Gestion des produits'),
('seller', 'basic_inventory', true, false, 'Inventaire de base'),
('seller', 'order_processing', true, false, 'Traitement des commandes'),
('seller', 'basic_analytics', true, false, 'Statistiques de base'),

-- Fonctionnalités VENDOR (PREMIUM)
('seller', 'advanced_analytics', true, true, 'Statistiques avancées'),
('seller', 'inventory_alerts', true, true, 'Alertes de stock'),
('seller', 'bulk_operations', true, true, 'Opérations en masse'),
('seller', 'virtual_wallet', true, true, 'Portefeuille virtuel'),
('seller', 'commission_management', true, true, 'Gestion des commissions'),
('seller', 'customer_chat', true, true, 'Chat client'),
('seller', 'delivery_management', true, true, 'Gestion des livraisons'),
('seller', 'automated_responses', true, true, 'Réponses automatisées'),
...
('freight_forwarder', 'shipment_management', true, false, 'Gestion des expéditions'),
('freight_forwarder', 'customs_handling', true, false, 'Gestion douanière'),
('freight_forwarder', 'client_portal', true, false, 'Portail client'),
('freight_forwarder', 'document_management', true, false, 'Gestion documentaire'),
...
-- 10. Fonction d'activation automatique des fonctionnalités
...
-- 11. Trigger pour activation automatique lors de la création/mise à jour du profil
...
BEGIN
    ...
    PERFORM public.activate_user_features(NEW.user_id, NEW.role::text);
    RETURN NEW;
END;
$$;
