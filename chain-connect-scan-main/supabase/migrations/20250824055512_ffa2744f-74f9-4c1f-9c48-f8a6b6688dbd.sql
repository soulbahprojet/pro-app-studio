-- Supprimer l'ancienne contrainte sur les types de services
ALTER TABLE services DROP CONSTRAINT IF EXISTS services_type_check;

-- Ajouter une nouvelle contrainte avec tous les types de services
ALTER TABLE services ADD CONSTRAINT services_type_check CHECK (
  type = ANY (ARRAY[
    'motard'::text, 
    'livreur'::text, 
    'boutique'::text, 
