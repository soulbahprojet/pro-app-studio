-- Création des tables pour le module Paiement & Escrow Alibaba-style

-- Table pour les Proforma Invoices (PI)
CREATE TABLE public.draft_orders (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  pi_number TEXT UNIQUE NOT NULL DEFAULT 'PI-' || TO_CHAR(now(), 'YYYYMMDD') || '-' || LPAD(nextval('pi_sequence'::regclass)::TEXT, 4, '0'),
...
-- Séquence pour les numéros de PI
