-- Corriger la fonction process_wallet_transfer pour ne pas créer de transaction de commission avec wallet_id NULL
...
BEGIN
  ...
  -- NOTE: Les frais de commission sont inclus dans la transaction d'envoi
  -- On ne crée plus de transaction séparée avec wallet_id NULL
