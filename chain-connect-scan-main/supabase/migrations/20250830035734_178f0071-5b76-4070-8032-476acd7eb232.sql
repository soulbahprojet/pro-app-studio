-- Fix security definer view and create proper schema
...
-- Insert basic features for each role if they don't exist (using ASCII only)
INSERT INTO public.role_features (role, feature, description, requires_subscription) VALUES
  ...
  ('seller', 'advanced_analytics', 'Analyses avancees', true),
...
-- Enable RLS on the view using security_barrier
